...
Além da demonstração da rede neural funcionando, um Relatório completo deve ser entregue, contendo informações como:

* Como os dados foram normalizados;
* Como foi separado o conjunto de  treinamento e de teste;
* Qual a arquitetura de rede utilizada;
* Quantos e Quais experimentos foram feitos até chegar no resultado final;
* Como foi o treinamento;
* Qual a taxa de acertos da rede;
* A matriz de confusão;
* Exemplos de objetos que foram mal-classificados pela Rede;
* Fatos que você achou interessante;
* etc...
